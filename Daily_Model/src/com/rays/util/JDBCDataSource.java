...
public final class JDBCDataSource {
	// make self type static variable static variable have one copy in there life time
	...
	// make default constructor private so no one another class can create instance of single/this class
